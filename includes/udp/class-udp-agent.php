...
class Udp_Agent {
	...
	public function on_admin_init() {
		...
		add_settings_field(
			'udp_agent_allow_tracking',
			esc_html__( 'Allow Anonymous Tracking', 'universal-google-adsense-and-ads-manager' ),
	...
	public function show_settings_ui() {
		...
		echo '/>';
		echo esc_html__( 'Become a super contributor by sharing your non-sensitive WordPress data. We guarantee no sensitive data is collected.', 'universal-google-adsense-and-ads-manager' );
		echo wp_kses_data( '<a href="https://creamcode.org/user-data-processing/" target="_blank" > ' . esc_html__( ' What data do we collect?', 'universal-google-adsense-and-ads-manager' ) . '</a>' );
		echo ' </p>';
	}
