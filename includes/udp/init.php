		...
		add_action(
			...
			function () {
				...
				$content .= sprintf(
					...
					esc_html__( 'Allow', 'universal-google-adsense-and-ads-manager' )
				);
				...
				$content .= sprintf(
					...
					esc_html__( 'Do not show again', 'universal-google-adsense-and-ads-manager' )
				);
				...
				$content .= sprintf(
					...
					esc_html__( 'Later', 'universal-google-adsense-and-ads-manager' )
				);
