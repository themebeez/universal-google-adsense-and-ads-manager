		...
		add_action(
			...
			function () {
				...
				$content = '<p>' . sprintf(
					...
					esc_html__( '%s is asking to allow tracking your non-sensitive WordPress data?', 'universal-google-adsense-and-ads-manager' ),
					$agent_name
				) . '</p>';

				$content .= '<p>';

				$content .= '<a href="' . esc_url( admin_url( '?udp-agent-allow-access=yes' ) ) . '" class="button button-primary udp-agent-access_tracking-yes" style="margin-right: 10px">' . esc_html__( 'Allow', 'universal-google-adsense-and-ads-manager' ) . '</a>';

				$content .= '<a href="' . esc_url( admin_url( '?udp-agent-allow-access=no' ) ) . '" class="button button-secondary udp-agent-access_tracking-yes" style="margin-right: 10px">' . esc_html__( 'Do not show again', 'universal-google-adsense-and-ads-manager' ) . '</a>';

				$content .= '<a href="' . esc_url( admin_url( '?udp-agent-allow-access=later' ) ) . '" class="button button-secondary udp-agent-access_tracking-yes" style="margin-right: 10px">' . esc_html__( 'Later', 'universal-google-adsense-and-ads-manager' ) . '</a>';
