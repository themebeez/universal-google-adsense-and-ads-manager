wp.customize.controlConstructor['responsive-dimensions'] = wp.customize.Control.extend({
	...
	jQuery( document ).ready( function($) {
		...
		// Linked button
		$( '.btn-group-linked' ).on( 'click', function() {
		...
		// Unlinked button
		$( '.btn-group-unlinked' ).on( 'click', function() {
